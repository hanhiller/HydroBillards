...
class TeslaValveSimulator(SimulatorBase):

    def __init__(self, temperature: float, config: TeslaValveSimulationConfig):
        self._current_direction = config.current_direction
        self._set_boundary_length(20.0)
        super().__init__(temperature, config)
        # self._set_boundary_length(9.)
    ...
    def update_body(self):
        ...
        self._border_x = border[:, 0]  # + np.ones(len(border)) * .5
    ...
    def _setup_current_direction(self):
        s, d, m, r, f = 2, 1, 0, -1, -2  # 'source','drain','mirror','rough'

        if self._current_direction == 'easy':
            self._edge_styles = np.array([m, m, m, m, m, m, m, m, m, m,
                                          m, m, m, m, m, m, m, m, m, m,
                                          m, m, m, m, m, m, m, m, m, m,
                                          m, m, m, m, m, m, m, m, m, m,
                                          m, m, m, m, m, m, m, m, m, m,
        ...
        elif self._current_direction == 'hard':
            self._edge_styles = np.array([m, m, m, m, m, m, m, m, m, m,
                                          m, m, m, m, m, m, m, m, m, m,
                                          m, m, m, m, m, m, m, m, m, m,
                                          m, m, m, m, m, m, m, m, m, m,
